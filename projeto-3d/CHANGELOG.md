...
| 2.4 | 24/09/2026 | Novo `modelo-3d.html`: modelo 3D completo em Three.js com os três pavimentos empilhados (dados corrigidos do `planta-obra-mariara.md`). Paredes geradas a partir dos cômodos, guarda-corpo nas varandas, laje e pilares na varanda coberta do 2º pav. Seletor de pavimento, separar pavimentos, paredes baixas, nomes, e toque no cômodo para ver medidas. | Claude |
| 2.5 | 25/09/2026 | `modelo-3d.html` refeito a partir do PDF do projeto aprovado (planta nº 934), no lugar do `planta-obra-mariara.md`, que tinha a disposição errada. Cômodos e paredes pelas cotas do projeto, níveis 0,36 / 3,24 / 6,12 / 9,00, portas e janelas nas posições do desenho com as medidas da tabela de esquadrias, escada em U, guarda-corpos, laje de cobertura com caixa d'água, muro com portões. Painel com a tabela de esquadrias. | Claude |
